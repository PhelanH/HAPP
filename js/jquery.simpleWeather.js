          ...
          if(data !== null && data.query.results !== null && data.query.results.channel.description !== 'Yahoo! Weather Error') {
            $.each(data.query.results, function(i, result) {
              ...
              var weather = {
                ...
                thumbnail: "img/weather/"+result.item.condition.code+".png",
                image: "img/weather/"+result.item.condition.code+".png",
                tomorrow:{
                  ...
                  image: "img/weather/"+result.item.forecast[1].code+".png"
                },
                forecasts:{
                  one:{
                    high: result.item.forecast[1].high,
                  ...
                  two:{
                    ...
                    image: "img/weather/"+result.item.forecast[2].code+".png"
                  },
                  three:{
                    ...
                    image: "img/weather/"+result.item.forecast[3].code+".png"
                  },
                  four:{
                    ...
                    image: "img/weather/"+result.item.forecast[4].code+".png"
                  },
                },
